...
public final class OnMessageCreatedSubscription implements Subscription<OnMessageCreatedSubscription.Data, OnMessageCreatedSubscription.Data, OnMessageCreatedSubscription.Variables> {
  ...
  public String operationId() {
    return "d61d37a5a52d8d7ef74351be2c4deff3fe4b5f6535ed4af62ff82214b8d2f0c8";
  }
  ...
  public static class OnMessageCreated {
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          ...
          writer.writeDouble($responseFields[5], utcTimestamp);
        }
      };
    }
    ...
    public int hashCode() {
      if (!$hashCodeMemoized) {
        ...
        h *= 1000003;
        h ^= Double.valueOf(utcTimestamp).hashCode();
        $hashCode = h;
        $hashCodeMemoized = true;
      }
      return $hashCode;
    ...
    public static final class Mapper implements ResponseFieldMapper<OnMessageCreated> {
      ...
      public OnMessageCreated map(ResponseReader reader) {
        ...
        final double utcTimestamp = reader.readDouble($responseFields[5]);
        return new OnMessageCreated(__typename, messageId, connectionId, cipherText, direction, utcTimestamp);
      }
    }
  }
}